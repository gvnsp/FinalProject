...
#print(datasets)
#'''Used the links from scapping to retrive income guidelines which are federally regulated evry year for house size between 1-8 for years 2016,2017,2018,2019,2020'''
...
#'''Used the API KEY to get the data and create a table before converting it into CSV File'''
...
#data.to_csv("guidlinesbystatebyyearCMS.csv") #Created a CSV format of data table
...
for item in years:
  ...
  #'''Used the API KEY to get the data and create a table before converting it into CSV File'''
  data_census.append(censusdata.json())
...
#df_census
#df_census.to_csv("CensusData2016-20.csv") #Created a CSV format of data table
